...
export default function Register() {
  ...
  function update(key: keyof typeof initial, value: string) { setForm(prev => ({ ...prev, [key]: value })); setErrors(prev => ({ ...prev, [key]: "" })); }
